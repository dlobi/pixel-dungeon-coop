...
import xyz.dlobi.pixeldungeoncoop.Rankings;
...
import xyz.dlobi.pixeldungeoncoop.windows.WndError;
import xyz.dlobi.pixeldungeoncoop.windows.WndRanking;
...
public class RankingsScene extends PixelScene {
	...
	public void create() {
		...
		if (Rankings.INSTANCE.records.size() > 0) {
			...
			float rowHeight = PixelDungeonCoop.landscape() ? ROW_HEIGHT_L : ROW_HEIGHT_P;
