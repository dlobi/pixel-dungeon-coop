...
import xyz.dlobi.pixeldungeoncoop.items.food.Pasty;
import xyz.dlobi.pixeldungeoncoop.items.potions.*;
import xyz.dlobi.pixeldungeoncoop.items.rings.*;
import xyz.dlobi.pixeldungeoncoop.items.scrolls.*;
import xyz.dlobi.pixeldungeoncoop.items.wands.*;
import xyz.dlobi.pixeldungeoncoop.items.weapon.*;
import xyz.dlobi.pixeldungeoncoop.items.weapon.melee.*;
import xyz.dlobi.pixeldungeoncoop.items.weapon.missiles.*;
import xyz.dlobi.pixeldungeoncoop.plants.*;
